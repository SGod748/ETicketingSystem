namespace ETicketingSystem
{
    partial class SelectMovieFrm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // mufasabtn
            // 
            mufasabtn.BackColor = Color.White;
            mufasabtn.BorderStyle = BorderStyle.FixedSingle;
            mufasabtn.Controls.Add(label13);
            mufasabtn.Controls.Add(label11);
            mufasabtn.Controls.Add(label12);
            mufasabtn.Controls.Add(label14);
            mufasabtn.Controls.Add(label15);
            mufasabtn.Controls.Add(label16);
            mufasabtn.Controls.Add(label17);
            ...
            mufasabtn.ResumeLayout(false);
            mufasabtn.PerformLayout();
